...
# it's the 2nd version of infrance.py
# infrance.py --> infrance_with_data.py --> infrance_code-review.py
# in this version, we have added integrated test cases to validate the inference function. It also has better error handling and logging practices, making it more robust for production use.
